function Get-RjRbStoredCredential {
    $credTarget = "RjRunbookDevelopment"
    Write-Warning "Trying to get cached credentials for target '$credTarget' (from Windows Credential Manager - 'Windows Credentials' - 'Generic Credentials')"
    Get-StoredCredential -Name $credTarget
}

# Source: https://gist.github.com/cdhunt/5729126
# License: MIT
